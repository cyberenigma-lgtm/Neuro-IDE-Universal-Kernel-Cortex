...
| :--- | :--- | :--- | :--- |
| **Dashboard** | Main interface | [Link](./DASHBOARD) | ✅ |
| **Storyteller** | Narrative engine | [Link](./STORYTELLER) | ✅ |
| **Neuro-Doctor** | Heuristic Diagnostics | [Link](./DOCTOR) | ✅ |
| **Neuro-Scope** | Log visualization | [Link](./SCOPE) | ✅ |
| **ELF Explorer** | Binary anatomy | [Link](./ELF_EXPLORER) | ✅ |
| **BootViz** | Memory visualization | [Link](./BOOTVIZ) | ✅ |
...
| Module / Módulo | Description | Guide / Guía | Photo |
| :--- | :--- | :--- | :--- |
| **Sandbox** | Env generator | [Link](./SANDBOX) | ✅ |
| **Syscall Mapper** | Kernel interface | [Link](./SYSCALL_MAPPER) | ✅ |
| **Profiler** | Performance trends | [Link](./PROFILER) | ✅ |
| **Knowledge Graph** | Dependency map | [Link](./KNOWLEDGE) | ✅ |
| **ScreenDiff** | Visual regression | [Link](./SCREEN_DIFF) | ✅ |
| **Hex Editor** | Byte manipulation | [Link](./HEX_EDITOR) | ✅ |
| **Disassembler** | ASM view | [Link](./DISASSEMBLER) | ✅ |
| **Mem Health** | Leak detection | [Link](./MEM_HEALTH) | ✅ |
...
Practical guides for common crisis: **[Go to Scenarios / Ir a Escenarios](./SCENARIOS)**.
